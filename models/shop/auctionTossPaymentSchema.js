...
const auctionTossSchema = new mongoose.Schema({
  productId: { type: mongoose.Types.ObjectId, ref: "Auction", required: true }, // 경매 제품 ID (참조)
...
export default mongoose.model("AuctionTossPayment", auctionTossSchema, "auctionTossPayments");
